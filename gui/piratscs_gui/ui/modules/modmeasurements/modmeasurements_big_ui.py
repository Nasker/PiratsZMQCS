...
class Ui_ModuleMeasurementsBig(object):
    def setupUi(self, ModuleMeasurementsBig):
        ...
        ModuleMeasurementsBig.resize(1172, 802)
        ...
        self.pb_channel_set = QtWidgets.QPushButton(ModuleMeasurementsBig)
        ...
        self.measPeriodValue = QtWidgets.QSpinBox(ModuleMeasurementsBig)
        self.measPeriodValue.setObjectName("measPeriodValue")
        self.horizontalLayout_13.addWidget(self.measPeriodValue)
        ...
        self.measFileName = QtWidgets.QLineEdit(ModuleMeasurementsBig)
        self.measFileName.setObjectName("measFileName")
        self.horizontalLayout_14.addWidget(self.measFileName)
        self.pb_file_name_set = QtWidgets.QPushButton(ModuleMeasurementsBig)
        self.pb_file_name_set.setObjectName("pb_file_name_set")
        self.horizontalLayout_14.addWidget(self.pb_file_name_set)
        ...
        self.label_7 = QtWidgets.QLabel(ModuleMeasurementsBig)
    ...
    def retranslateUi(self, ModuleMeasurementsBig):
        ...
        self.pb_channel_set.setText(_translate("ModuleMeasurementsBig", "Send"))
        ...
        self.pb_file_name_set.setText(_translate("ModuleMeasurementsBig", "Send"))
        ...
        self.label_7.setText(_translate("ModuleMeasurementsBig", "Asyncs"))
        ...
        self.start_acq_btn.setText(_translate("ModuleMeasurementsBig", "Start Sampling"))
        self.stop_acq_btn.setText(_translate("ModuleMeasurementsBig", "Stop Sampling"))
