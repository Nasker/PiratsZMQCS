...
class Ui_ModuleMeasurementsBig(object):
    def setupUi(self, ModuleMeasurementsBig):
        ...
        self.measPeriodValue.setMinimum(10)
        self.measPeriodValue.setMaximum(10000)
        self.measPeriodValue.setSingleStep(10)
        self.measPeriodValue.setProperty("value", 1000)
