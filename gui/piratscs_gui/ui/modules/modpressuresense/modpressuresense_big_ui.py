...
class Ui_ModulePressureSenseBig(object):
    def setupUi(self, ModulePressureSenseBig):
        ...
        self.line_2 = QtWidgets.QFrame(ModulePressureSenseBig)
        ...
        self.label_2 = QtWidgets.QLabel(ModulePressureSenseBig)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout.addWidget(self.label_2)
        self.spin_period_set = QtWidgets.QSpinBox(ModulePressureSenseBig)
        ...
        self.pb_period_set = QtWidgets.QPushButton(ModulePressureSenseBig)
    ...
    def retranslateUi(self, ModulePressureSenseBig):
        ...
        self.label_2.setText(_translate("ModulePressureSenseBig", "Measurement Period(ms)"))
        self.pb_period_set.setText(_translate("ModulePressureSenseBig", "Send"))
