...
class AsyncReceiver(object):
    ...
    def _register_all(self, async_callback):
        ...
        self._be.comm_client.async_subscribe('measurement_temp', async_callback)
        self._be.comm_client.async_subscribe('measurement_pressure', async_callback)
        self._be.comm_client.async_subscribe('measurement_weight', async_callback)
        self._be.comm_client.async_subscribe('measurement_voltage', async_callback)
