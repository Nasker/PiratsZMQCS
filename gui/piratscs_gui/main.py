...
if __name__ == '__main__':
    ...
    from piratscs_gui.system.paths import create_paths_if_not_exists, CONFIG_YAML_FILE_PATH
    ...
    if conf.logging.save_logs:
        from piratscs_gui.system.logger import log_add_file_handler
        log_add_file_handler(conf.logging.log_path)
    if conf.logging.show_stream:
        from piratscs_gui.system.logger import log_add_stream_handler
