...
class ModPiratsTemp(ModuleBase):
    ...
    # with other modules
    _async_topics = ['modpiratstemp_current']
    ...
    def _pub_current_temp(self, value):
        ...
        self.app.server.pub_async('modpiratstemp_current', value)
    ...
    def set_temp_channel(self, channel):
        ...
        try:
            ...
            raise Exception(f'Invalid value for set channel ({channel}), it must be a number')
